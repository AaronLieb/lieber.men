...
app.get('/phishme', (req, res) => {
    res.sendFile(path_1.default.join(__dirname + '/../public/phishme.html'));
});
app.post('/phishme', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const body = req.body;
    yield (0, db_1.query)("INSERT INTO Users (name) VALUES (?);", [body.name]);
    yield (0, db_1.query)("INSERT INTO Links (name, createdBy) VALUES (?, ?);", [body.name, body.url]);
